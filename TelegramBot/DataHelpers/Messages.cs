...
namespace TelegramBot.DataHelpers
{
    ...
    {
        public static string KYB_Start = "/start";
        public static string KYB_Back = "Ortga";
        public static string KYB_Phone = "📞 Mening nomerim";
        public static string KYB_About = "🗣 Biz haqimizda";
        public static string KYB_Order = "🛒 Buyurtma berish";
