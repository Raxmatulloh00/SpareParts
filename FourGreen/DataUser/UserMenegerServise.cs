...
namespace Web_Hotel.Data
{
    public class UserMenegerServise
    {
        ...
        readonly FourgreenDbContext _travel;

        public UserMenegerServise(UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager, FourgreenDbContext travel)
        {
